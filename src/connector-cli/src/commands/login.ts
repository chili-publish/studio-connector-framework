...
async function executeDeviceFlowAndGenerateAccessToken(): Promise<AccessToken | undefined> {
    ...
    try {
        ...
        info(`Please visit ${deviceCode.verification_uri_complete} and enter the code ${deviceCode.user_code} to authenticate.`);
