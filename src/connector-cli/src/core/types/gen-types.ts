...
const typeMap: any = {
  ChiliToken: o([{ json: 'name', js: 'name', typ: '' }], false),
  Oauth2AuthorizationCode: o(
    [
      {
        json: 'authorizationServerMetadata',
        js: 'authorizationServerMetadata',
        typ: r('AuthorizationServerMetadata'),
      },
      ...
      {
        json: 'specCustomization',
        js: 'specCustomization',
        typ: u(undefined, r('SpecCustomization')),
      },
    ],
    false
  ),
  AuthorizationServerMetadata: o(
    [
      ...
      { json: 'token_endpoint', js: 'token_endpoint', typ: '' },
      {
        ...
        js: 'token_endpoint_auth_methods_supported',
        typ: a(r('TokenEndpointAuthMethodsSupported')),
      },
    ],
    false
  ),
  SpecCustomization: o(
    [
      {
        json: 'codeParameterName',
        js: 'codeParameterName',
        typ: u(undefined, ''),
      },
      {
        json: 'requestContentType',
        js: 'requestContentType',
        typ: u(undefined, r('RequestContentType')),
      },
    ],
    false
  ),
  ...
  ConnectorConfig: o(
    [
      ...
      { json: 'options', js: 'options', typ: m('any') },
      {
        json: 'supportedAuth',
        js: 'supportedAuth',
        typ: u(undefined, a(r('SupportedAuth'))),
      },
