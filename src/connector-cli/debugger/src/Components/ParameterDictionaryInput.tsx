...
export const ParameterDictionaryInput = ({ parentParameter, parameter, onChange }: { parentParameter: Parameter | undefined; parameter: Parameter; onChange: (name: string, parameter: Parameter, value: any) => void; }) => {
