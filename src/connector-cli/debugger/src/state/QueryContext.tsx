...
const initialState: State = { queryOptions: { token: '', filter: '', collection: '', pageSize: 10 }, metadata: [] };
...
export const QueryOptionsProvider: React.FC<{children: ReactNode}> = ({ children }) => {
